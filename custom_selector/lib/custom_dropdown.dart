...
//}
//
//class _DropdownRoute<T> extends PopupRoute<DropdownRouteResult<T>> {
//  _DropdownRoute({
//    this.items,
//    this.padding,
//    this.buttonRect,
...
class _DropdownButtonState<T> extends State<CustomDropdownButton<T>>
  ...
  void _updateSelectedIndex() {
    for (DropdownMenuItem item in widget.items) {
      print("WidgetValue: ${widget.value} ;  item value: ${item.value}");
    }
  ...
  void _handleTap() {
    ...
    _dropdownRoute = new DropdownRoute<T>(
      menuBorderColor: widget.menuBorderColor,
    ...
    Widget result = new DefaultTextStyle(
      ...
      child: new Container(
        decoration: BoxDecoration(
          border: Border.all(color: widget.menuBorderColor),
          borderRadius: new BorderRadius.circular(2.0),
